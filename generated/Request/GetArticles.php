...
use Myrzan\TecDocClient\Generated\Record\AssemblyGroupFacetOptions;
use Myrzan\TecDocClient\Generated\Record\CriteriaFilter;
...
class GetArticles
{
     ...
     *
     * @var AssemblyGroupFacetOptions $assemblyGroupFacetOptions
     */
     ...
     *
     * @param CriteriaFilter $criteriaFilters
     *@return self
     */
    public function addToCriteriaFilters(CriteriaFilter $criteriaFilters)
    {
     ...
     *@return self
     */
    public function addToSort(Sort $sort)
    {
        $this->sort[] = $sort;
        return $this;
    }
     ...
     * Options for returning assembly group facets. Defaults to false.
     *
     * @param AssemblyGroupFacetOptions $assemblyGroupFacetOptions
     * @return self
     */
    public function setAssemblyGroupFacetOptions(AssemblyGroupFacetOptions $assemblyGroupFacetOptions)
    {
